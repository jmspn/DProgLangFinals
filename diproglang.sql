...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2025 at 06:42 AM
...
ALTER TABLE `employee`
  ...
  ADD CONSTRAINT `employee_ibfk_2` FOREIGN KEY (`position_id`) REFERENCES `jobposition` (`id`) ON DELETE SET NULL;
